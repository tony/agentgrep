...
:::{grid-item-card} OpenTelemetry cost model
:link: otel-cost-model
:link-type: doc
Development-only cost and signal inventory for traces, metrics, logs, profiles, subprocesses, and live Grafana LGTM acceptance checks.
:::
