...
from agentgrep.ui.widgets import ExportDialog, FilterCompleted, SearchRequested
...
async def _load_records(
    ...
    *,
    ...
    row_index = next(
        index for index, record in enumerate(screen.filtered_records) if record is selected_record
    )
    screen._results.highlighted = row_index
    screen._current_detail_record = selected_record
